...
Intentionally-deferred work and docs/implementation drift findings are
tracked as GitHub issues, one per item (#689 retired the old standing ledger
file), not re-derived from scratch each audit.
