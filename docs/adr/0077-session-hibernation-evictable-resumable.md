...
- Status: Accepted — Amended by [0144] (pause/resume), [0168](0168-lazy-prompt-refuses-a-known-hibernated-child.md) (`parent_links` survives hibernation; lazy-`Prompt` refuses a known child)
- Date: 2026-07-15
