...
OutEvent : SessionStarted | SessionEnded | SessionList | History | Status
          ...
          | ToolOutput | TaskList | Usage | Error | Done | FileChange           (engine → harness)
```
